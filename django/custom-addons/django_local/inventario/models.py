...
class Categoria(models.Model):
    ...
    def __str__(self):
        # Corregido: Se unificó el return para que muestre el código y el nombre
...
# ─── Modelo venta_de_atre ───────────────────────────────────────
class venta_de_atre(models.Model):
    cliente   = models.CharField(max_length=100)
    telefono  = models.CharField(max_length=100)
    # Corregido: Cambiado a CharField con max_length para almacenar texto
...
class factura(models.Model):
    ...
    # Corregido: Cambiado a CharField porque estaba configurado como DecimalField
    direccion = models.CharField(max_length=255)
    pedido    = models.PositiveIntegerField(default=0)
